...
.ORIG x3000				  	
            ...
            ADD   R3,R3,R2            ; R3 contains input number -2		*(there were 2 commas, only one was required)*
...
INNERLOOP   ADD   R5,R5,R1            ; Increment sum
            ...
            LD    R5,ZERO             ; Clear R5 (previous sum) to 0		*(have used a label here in place of x300F)*
